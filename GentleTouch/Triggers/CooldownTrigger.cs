...
namespace GentleTouch.Triggers
{
    public class CooldownTrigger : VibrationTrigger
    {
        ...
        public CooldownTrigger(uint jobId, string actionName, uint actionId, int actionCooldownGroup,
        ...
        internal CooldownTrigger(uint jobId, string actionName, uint actionId, int actionCooldownGroup,
            int priority,
